...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    "en": {
        ...
        "limit_must_be_non_negative": "Limit must be a non-negative integer",
        ...
        "schema_command_not_found": "Command not found: {command}",
        ...
        "custom_app_update_app_name": "Application name (optional)",
        "custom_app_update_app_label": "Application labels (optional, format: JSON array or comma-separated string)",
        "custom_app_update_extract_fields": "Field configuration in JSON format or JSON file path (required).",
        "custom_app_update_parse_mode": "Parse mode (required): standard=standard parsing; advance=advanced parsing; agentic=agentic parsing",
        "custom_app_update_enable_long_doc": "Enable long document support (required, true/false)",
        "custom_app_update_long_doc_config": "Long document configuration in JSON format or JSON file path (required when enable-long-doc=true)",
    ...
    "zh": {
        ...
        "schema_command_not_found": "未找到命令: {command}",
        ...
        "custom_app_update_app_name": "应用名称（可选）",
        "custom_app_update_app_label": "应用标签（可选，格式：JSON 数组或逗号分隔字符串）",
        "custom_app_update_extract_fields": "字段配置，JSON 格式或 JSON 文件路径（必填）",
        "custom_app_update_parse_mode": "解析模式（必填）：standard=标准解析；advance=增强解析；agentic=智能体解析",
        "custom_app_update_enable_long_doc": "启用长文档支持（必填，true/false）",
        "custom_app_update_long_doc_config": "长文档配置，JSON 格式或 JSON 文件路径（当 enable-long-doc=true 时必填）",
        ...
        "limit_must_be_non_negative": "Limit 值必须为非负整数",
